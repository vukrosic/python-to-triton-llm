# triton_div_add_sub_mul_relu_layer_norm.py
...
def torch_div_add_sub_mul_relu_layer_norm(x, y, z, w, v, normalized_shape, weight, bias, eps):
...
# Triton kernel - fused div + add + sub + mul + ReLU + layer normalization
@triton.jit
def div_add_sub_mul_relu_layer_norm_kernel(
...
def triton_div_add_sub_mul_relu_layer_norm(x, y, z, w, v, normalized_shape, weight, bias, eps=1e-5):
    ...
    # Launch kernel
    div_add_sub_mul_relu_layer_norm_kernel[grid](
...
def test_correctness():
    ...
    torch_result = torch_div_add_sub_mul_relu_layer_norm(x, y, z, w, v, normalized_shape, weight, bias, eps)
    triton_result = triton_div_add_sub_mul_relu_layer_norm(x, y, z, w, v, normalized_shape, weight, bias, eps)
...
def benchmark():
    ...
    for M, N in sizes:
        ...
        # Warmup
        for _ in range(5):
            _ = torch_div_add_sub_mul_relu_layer_norm(x, y, z, w, v, normalized_shape, weight, bias, eps)
            _ = triton_div_add_sub_mul_relu_layer_norm(x, y, z, w, v, normalized_shape, weight, bias, eps)
