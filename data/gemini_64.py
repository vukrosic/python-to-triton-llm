...
def torch_exp_sqrt(x):
    """Standard PyTorch implementation"""
    return torch.sqrt(torch.exp(x))

# Triton kernel - fused element-wise Exponential + Square Root
@triton.jit
def exp_sqrt_kernel(
    x_ptr,
    output_ptr,
...
def test_correctness():
    ...
    torch_result = torch_exp_sqrt(x)
    triton_result = triton_exp_sqrt(x)
