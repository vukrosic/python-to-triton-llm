...
def torch_cube_exp(x):
    """Standard PyTorch implementation"""
    return torch.exp(x * x * x)

# Triton kernel - fused element-wise Cube + Exponential
@triton.jit
def cube_exp_kernel(
    x_ptr,
    output_ptr,
...
def test_correctness():
    ...
    torch_result = torch_cube_exp(x)
    triton_result = triton_cube_exp(x)
