...
def torch_div_leaky_relu(x, y, negative_slope):
    """Standard PyTorch implementation"""
    return torch.nn.functional.leaky_relu(x / y, negative_slope=negative_slope)

# Triton kernel - fused element-wise Division + Leaky ReLU
@triton.jit
...
def triton_div_leaky_relu(x, y, negative_slope):
...
def test_correctness():
    ...
    torch_result = torch_div_leaky_relu(x, y, negative_slope)
    triton_result = triton_div_leaky_relu(x, y, negative_slope)
...
def benchmark():
    ...
    for M, N in sizes:
        ...
        # Warmup
        for _ in range(10):
            _ = torch_div_leaky_relu(x, y, negative_slope)
            _ = triton_div_leaky_relu(x, y, negative_slope)
