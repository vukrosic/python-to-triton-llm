# triton_div_add_mul_sub_silu_rms_norm.py
...
def torch_div_add_mul_sub_silu_rms_norm(x, y, z, w, v, weight, eps):
...
# Triton kernel - fused div + add + mul + sub + SiLU + RMS normalization
@triton.jit
def div_add_mul_sub_silu_rms_norm_kernel(
...
def triton_div_add_mul_sub_silu_rms_norm(x, y, z, w, v, weight, eps=1e-6):
    ...
    # Launch kernel
    div_add_mul_sub_silu_rms_norm_kernel[grid](
...
def test_correctness():
    ...
    torch_result = torch_div_add_mul_sub_silu_rms_norm(x, y, z, w, v, weight, eps)
    triton_result = triton_div_add_mul_sub_silu_rms_norm(x, y, z, w, v, weight, eps)
...
def benchmark():
    ...
    for M, N in sizes:
        ...
        # Warmup
        for _ in range(5):
            _ = torch_div_add_mul_sub_silu_rms_norm(x, y, z, w, v, weight, eps)
            _ = triton_div_add_mul_sub_silu_rms_norm(x, y, z, w, v, weight, eps)
