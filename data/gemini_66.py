...
def torch_neg_cube(x):
    """Standard PyTorch implementation"""
    return -(x * x * x)

# Triton kernel - fused element-wise Negation + Cube
@triton.jit
def neg_cube_kernel(
    x_ptr,
    output_ptr,
...
def test_correctness():
    ...
    torch_result = torch_neg_cube(x)
    triton_result = triton_neg_cube(x)
