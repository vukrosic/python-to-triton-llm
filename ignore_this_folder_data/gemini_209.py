...
def torch_div_hardtanh(x, y, min_val, max_val):
    """Standard PyTorch implementation"""
    return torch.nn.functional.hardtanh(x / y, min_val=min_val, max_val=max_val)

# Triton kernel - fused element-wise Division + Hardtanh
@triton.jit
def div_hardtanh_kernel(
...
def triton_div_hardtanh(x, y, min_val, max_val):
...
def test_correctness():
    ...
    torch_result = torch_div_hardtanh(x, y, min_val, max_val)
    triton_result = triton_div_hardtanh(x, y, min_val, max_val)
...
def benchmark():
    ...
    for M, N in sizes:
        ...
        # Warmup
        for _ in range(10):
            _ = torch_div_hardtanh(x, y, min_val, max_val)
            _ = triton_div_hardtanh(x, y, min_val, max_val)
