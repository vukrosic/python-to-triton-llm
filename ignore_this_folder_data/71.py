...
def triton_div_mul_sub_silu(x, y, z, w):
...
def test_correctness():
    ...
    torch_result = torch_div_mul_sub_silu(x, y, z, w)
    triton_result = triton_div_mul_sub_silu(x, y, z, w)
...
def benchmark():
    ...
    for M, N in sizes:
        ...
        # Warmup
        for _ in range(5):
            _ = torch_div_mul_sub_silu(x, y, z, w)
            _ = triton_div_mul_sub_silu(x, y, z, w)
